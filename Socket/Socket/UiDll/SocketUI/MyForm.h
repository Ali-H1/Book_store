...
[DllImport("ServerDLL.dll", CallingConvention = CallingConvention::Cdecl)]
extern void Update_(IntPtr, wstring, wstring, wstring);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label14->Location = System::Drawing::Point(66, 0);
			this->label14->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label14->Name = L"label14";
			this->label14->Size = System::Drawing::Size(76, 29);
			...
			this->label13->Font = (gcnew System::Drawing::Font(L"B Nazanin", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(178)));
			this->label13->Location = System::Drawing::Point(86, 67);
			this->label13->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label13->Name = L"label13";
			this->label13->Size = System::Drawing::Size(56, 29);
			...
			this->button4->Location = System::Drawing::Point(81, 136);
			...
			this->button3->Location = System::Drawing::Point(33, 174);
			...
			this->signin_panel->Location = System::Drawing::Point(0, 212);
			...
			this->panel12->Location = System::Drawing::Point(0, 255);
			...
			this->panel3->Location = System::Drawing::Point(-12, 300);
			...
			this->label9->Size = System::Drawing::Size(68, 29);
			...
			this->panel18->Location = System::Drawing::Point(-12, 345);
			...
			this->panel23->Location = System::Drawing::Point(0, 390);
			...
			this->category_panel->Location = System::Drawing::Point(0, 435);
...
#pragma endregion
	...
	public: static void add_admin()
	{
		...
		Open_(db);
		wstring user, pass;
		MarshalwString(SighinAdminUC::username->Text, user);
		MarshalwString(SighinAdminUC::password->Text, pass);
		if (user != L"" && pass != L"")
		{
			wstring value = L"('" + user + L"','" + pass + L"')";
			int isinsert = Insert(db, L"admins", L"(username,password)", value);
	...
	private: System::Void panel12_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		for each (Button ^ ctrl in Uc3->Controls->Find("add_btn", true))
		{
			Uc3->addMethod += gcnew adduserhandler(add_admin);
		}
    ...
    private: System::Void panel3_Click(System::Object^ sender, System::EventArgs^ e) {//user control 
		...
		for each (Button ^ ctrl in Uc5->Controls->Find("change_button", true))
		{
			Uc5->editMethod += gcnew editHandler(update_book);
		}
	    ...
	    MainPanel->Controls->Add(Uc5);
		  ...
		  public:static void update_book()
		  {
			  auto db = CreateObject("ServerDataBase.db");
			  Open_(db);
			  wstring name, author_st, category, year_st, ver_st, Price_st, translator_st, publisher_st, language_st, summery_st, coverpath_st, file_path = L"NULL", id;
			  ...
			  MarshalwString(BookUC::id, id);

			  int indexarr[2] = { 1,3 };
			  wstring patharr[2] = { coverpath_st,file_path };
			  std::wstring avalable_ws = std::wstring_convert<std::codecvt_utf8<wchar_t>>().from_bytes(to_string(BookUC::avalable));
			  std::wstring digital_ws = std::wstring_convert<std::codecvt_utf8<wchar_t>>().from_bytes(to_string(BookUC::digital));

			  wstring set = L" SET Title = '" + name + L"', Author = '" + author_st + L"', Genre = '" +
				  category + L"', Publish_Year = '" + year_st + L"', Edition = '" + ver_st + L"',Translator ='" +
				  translator_st + L"', Price = '" + Price_st + L"',Publisher = '" + publisher_st + L"', language ='" +
				  language_st + L"', Summery ='" + summery_st + L"', Avalable ='" + avalable_ws + L"', Digital ='" + digital_ws +
				  L"'";
			  id = id.substr(0, 4);
			  Update_(db, L"Books", set, L" WHERE ID = " + id);
