...
public:
	...
	bool Insert(string table ,string listtitle,string values)
	{
		sqlite3_stmt* stmt = NULL;
		sql = "INSERT INTO "+table+" "+listtitle+" VALUES"+values+"; ";
	...
	void Select(string item="*",string condition="")
	{
		sql = "SELECT "+item+" from userdata"+condition;
	...
	int generating_id(int start, int end)
	{
